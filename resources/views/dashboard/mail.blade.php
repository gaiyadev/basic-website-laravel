    ...
    <div id="sidebar" class="nav-collapse">
        <!-- sidebar menu start-->            <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li class="active"><a href="/mail">Inbox</a></li>
                ...
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-pills nav-stacked mail-nav">
                            <li class="active"><a href="/mail"> <i class="fa fa-inbox"></i> Inbox  <span class="label label-danger pull-right inbox-notification">9</span></a></li>
            ...
            <div class="col-sm-9">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       <h4 class="gen-case text-info"><span class="text-primary">Inbox (34)</span>
                    ...
                    <div class="panel-body minimal">
                        ...
                        <tbody>                  
                            ...
                            <tr class="">
                                ...
                                <td class="view-message inbox-small-cells">{{ $message->email }}</td>
                                <td class="view-message inbox-small-cells">{{ $message->message }}</td>
                                <td class="view-message text-right">{{ $message->created_at }}</td>
                                <td class="view-message text-right"> <?php
                                    echo Form::open(['action' => ['MessagesController@destroy', $message->id], 
