            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <tr class="gradeX">
                        <td> {{ $post->id }} </td>
                        <td>{{ $post->title }}</td>                        
                        <td class="center hidden-phone">{!! $post->body !!}</td>
                        <td>{{ $post->category }}</td> 
                        <td>{{ $post->created_at }}</td> 
                        <td>
                                <?php
                                    echo Form::open(['action' => ['PostsController@destroy', $post->id], 
                            ...
                            &nbsp&nbsp<a href="/view/{{ $post->id }}/blank" class="btn btn-info" >Update</a></td>
